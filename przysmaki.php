...
<table class="table table-condensed" id="tabtowary">
  ...
  <?PHP
    ...
    $zapytanie="SELECT * FROM przysmaki ORDER BY nazwa ASC";
    ...
    while($wiersz = $result->fetch_assoc())
{
    ...
    if(isset($_SESSION['pu']) && ($_SESSION['pu']==0)){ 
      echo "<a href=deleteprzysmak.php?id=".$wiersz['id']."><button>X</button></a>";
...
<form method="POST" action="dodajprzysmak.php" id="formAddTowar">
